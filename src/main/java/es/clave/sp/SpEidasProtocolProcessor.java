...
public final class SpEidasProtocolProcessor extends EidasProtocolProcessorNoMetadata implements ProtocolProcessorNoMetadataI {
    ...
    public SpEidasProtocolProcessor(@Nonnull final AttributeRegistry additionalAttributeRegistry) {
        super(additionalAttributeRegistry);
    }

    public SpEidasProtocolProcessor(@Nonnull final String eidasAttributesFileName,
                                    @Nonnull final String additionalAttributesFileName,
                                    @Nullable final String defaultPath) {
        super(eidasAttributesFileName, additionalAttributesFileName, defaultPath);
    }

    public SpEidasProtocolProcessor(@Nonnull final AttributeRegistry eidasAttributeRegistry,
                                    @Nonnull final AttributeRegistry additionalAttributeRegistry) {
    ...
    @Override
    @Nonnull
    public AttributeDefinition<?> getAttributeDefinitionNullable(@Nonnull final String name) {
        ...
        final AttributeDefinition<String> unknownAttribute = AttributeDefinition.<String>builder().nameUri(name)
